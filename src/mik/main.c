...
//
// Προκειμένου να διευρύνουμε το εύρος των υπολογισμών, καταφεύγουμε σε
// double data types για στοιχεία του προγράμματος που μπορεί να πάρουν
// πολύ μεγάλες τιμές. Ωστόσο, υπάρχει κάποιο όριο που θέτει το πρόγραμμα
// ώστε να αποφευχθούν εξωτικές καταστάσεις και παραπλανητικά αποτελέσματα.
// Το όριο αυτό σήμερα είναι της τάξης του 10000.
